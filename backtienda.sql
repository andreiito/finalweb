...
INSERT INTO comics VALUES (2, 'Amazing spiderman', 4, 320, 'img_comics/spiderman.jpeg', 1, 1);
INSERT INTO comics VALUES (3, 'Civil War', 4, 400, 'img_comics/civil_war.jpeg', 1, 1);
...
ALTER TABLE ONLY autoresxcomics
    ADD CONSTRAINT autoresxcomics_id_autor_fkey FOREIGN KEY (id_autor) REFERENCES autores(id_autor);
...
ALTER TABLE ONLY autoresxcomics
    ADD CONSTRAINT autoresxcomics_id_comic_fkey FOREIGN KEY (id_comic) REFERENCES comics(id_comic);
...
ALTER TABLE ONLY comics
    ADD CONSTRAINT comics_id_descuento_fkey FOREIGN KEY (id_descuento) REFERENCES descuento(id_descuento);
...
ALTER TABLE ONLY comics
    ADD CONSTRAINT comics_id_editorial_fkey FOREIGN KEY (id_editorial) REFERENCES editoriales(id_editorial);
...
ALTER TABLE ONLY direccion
    ADD CONSTRAINT direccion_id_usuario_fkey FOREIGN KEY (id_usuario) REFERENCES usuarios(id_usuario);
...
ALTER TABLE ONLY direccion
    ADD CONSTRAINT direccion_id_usuario_fkey1 FOREIGN KEY (id_usuario) REFERENCES usuarios(id_usuario) ON DELETE CASCADE;
...
ALTER TABLE ONLY usuarios
    ADD CONSTRAINT usuarios_id_tipo_fkey FOREIGN KEY (id_tipo) REFERENCES tipousuario(id_tipo);
...
ALTER TABLE ONLY venta
    ADD CONSTRAINT venta_id_usuario_fkey FOREIGN KEY (id_usuario) REFERENCES usuarios(id_usuario);
...
ALTER TABLE ONLY ventaxcomics
    ADD CONSTRAINT ventaxcomics_id_comic_fkey FOREIGN KEY (id_comic) REFERENCES comics(id_comic);
...
ALTER TABLE ONLY ventaxcomics
    ADD CONSTRAINT ventaxcomics_id_venta_fkey FOREIGN KEY (id_venta) REFERENCES venta(id_venta);
