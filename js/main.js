...
$(document).ready(function() {
     ...
     /* $('.cerrar').attr('aria-label',''+contenido); */
      ...
      var contenido = $('.contenidoAlertas').html();
      console.log(contenido)
...
************************************************************************************/
/*Contenido default*/
$( ".pestañas-contenido div").hide();/*oculta todo el contenido de pestañas contenido*/
$( ".pestañas-contenido div.uno").show();/*muestra el contenido de la primer pestaña*/
...
var pestanaFoco = function(elemento){
	//variable que recibe el valor de data_target del li que le dieron click o enter
	...
	//mandamos el foco al pestañas-contenido
...
$(".cuenta_atras").each(function(){ 
	var contador_m = Number($('.minutos').html()); //convertí el valor de texto a numeros para poder evaluar su magintud con el "<" y ">"
	var contador_s = Number($('.segundos').html());
	var abrir_alerta = Number($('.abrir_alerta').html()); // tiempo en segundos de cada cuando se abrira la alerta
...
$(".boton_transcript").click(function(){
    ...
    $(".contenido_transcript").load(direccion_track+".txt");
});
