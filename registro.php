		...
		<form action="alta_usuario.php" method="post">
			...
			<fieldset class="fieldset_form"> <legend class="legend_form"> Registrarse a la p&aacute;gina </legend> 
				...
				<div class="form_grupo">
					...
					<input type="text" class="form_control_grande" aria-label="input de Texto" id="inputText" name="del" placeholder="texto" />  
				</div>
				...
				<div class="form_grupo">
					...
					<input type="text" class="form_control_grande" aria-label="input de Texto" id="inputText" name="tel" placeholder="texto" />  
				</div>
